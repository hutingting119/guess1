...
describe('game',()=> {
    ...
    it('should Congtatulations', ()=> {
        const receipt=game.receipt('1234', '1234', 1);
        expect(receipt).toEqual('Congratulations!');

    })

    it('should run', ()=> {
        spyOn(game, 'receipt').and.returnValue('1234');
        for (let i = 6; i > 0; i--) {
...
// describe('Game', () => {
//     beforeEach(() => {
//         spyOn(AnswerGenrator, 'answer').and.returnValue('1234');
//         spyOn(console, 'log');
//         spyOn(process, 'exit');
//
//        // const game = new Game();
